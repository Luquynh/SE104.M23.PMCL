...
namespace PhanMemQLTV
{
    ...
    public partial class frmQLSach : Form
    {
        ...
        private DataTable ketnoi(string truyvan)
        {
            ...
            dataGridViewDSSach.Columns[1].DefaultCellStyle.Format = "dd/MM/yyyy";
            return myTable;
        }
        ...
        private void dataGridViewDSSach_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                txtTheLoai1.Text = myTable.Rows[row]["TheLoai"].ToString();
                TheLoai = txtTheLoai1.Text;
        ...
        private void themSach()
        {
            try
            {
                string query = "set dateformat dmy; insert into tblSach values ('" + txtMaSach.Text + "','" + dtmNgNhapSach.Text + "', N'" + txtTenSach.Text + "',N'" + txtTheLoai1.Text + "',N'" + txtTacGia.Text + "',N'" + txtNXB.Text + "','" + txtNamXB.Text + "','" + txtSLNhap.Text + "','" + txtTriGia.Text + "',N'" + cboTinhTrang.Text + "',N'" + txtGhiChu.Text + "')";
                ketnoi(query);
                myCommand.ExecuteNonQuery();
        ...
        private void dataGridViewDSSach_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtTheLoai1.Text = dataGridViewDSSach.CurrentRow.Cells[3].Value.ToString();
            ...
            txtSLNhap.Text = dataGridViewDSSach.CurrentRow.Cells[7].Value.ToString();
            txtTriGia.Text = dataGridViewDSSach.CurrentRow.Cells[8].Value.ToString();
        ...
        private void btbHome_Click(object sender, EventArgs e)
        {
            this.Close();
        }
        ...
        private void suaSach()
        {
            ...
            {
                string capnhatdong;
                capnhatdong = "update tblSach set TenSach=N'" + txtTenSach.Text + "',TheLoai=N'" + txtTheLoai1.Text + "',TacGia=N'" + txtTacGia.Text + "',NXB=N'" + txtNXB.Text + "',NamXB='" + txtNamXB.Text + "',SLNhap='" + txtSLNhap.Text + "',TriGia='" + txtTriGia.Text + "',TinhTrang=N'" + cboTinhTrang.Text + "',GhiChu=N'" + txtGhiChu.Text + "' where MaSach='" + txtMaSach.Text + "'";
                //capnhatdong = "update tblSach set TenSach=N'" + txtTenSach.Text + "',TheLoai=N'" + txtTheLoai1.Text + "',TacGia=N'" + txtTacGia.Text + "',NXB=N'" + txtNXB.Text + "',NamXB='" + txtNamXB.Text + "',SLNhap='" + txtSLNhap.Text + "',TriGia='" + txtTriGia.Text + "',TinhTrang=N'" + cboTinhTrang.Text + "' where MaSach='" + txtMaSach.Text + "' ";
                ketnoi(capnhatdong);
                myCommand.ExecuteNonQuery();
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (txtTheLoai1.Text == "")
            {
                errCD.SetError(txtTheLoai1, "Vui lòng nhập Chủ Đề");
            }
            else
            {
                errCD.Clear();
            ...
            if (dtmNgNhapSach.Text.Length>0 && txtTenSach.Text.Length > 0 && txtTacGia.Text.Length > 0 && txtNXB.Text.Length > 0 && txtTheLoai1.Text.Length > 0 && isNumberSLNhap == true && isNumberTriGia == true && cboTinhTrang.Text.Length > 0 && isNumberNamXB == true)
            {
                    if (xuly == 0)
                    {
                        themSach();
            ...
            else
            {
                ...
                if (txtTenSach.Text.Length == 0)
                    txtTenSach.Focus();
                else if (txtTheLoai1.Text.Length == 0)
                    txtTheLoai1.Focus();
